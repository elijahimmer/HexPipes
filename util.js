...
// buckets in order
const base5Colors = [...[0, 5, 13, 20].map((index) => base15ColorFromIndex(index)), "#FFFFFF"];
...
const base15Colors = [...[0,2, 6,7,8,9,10,11, 16,18,20, 23,25,27].map((index) => base15ColorFromIndex(index)), "#FFFFFF"];
